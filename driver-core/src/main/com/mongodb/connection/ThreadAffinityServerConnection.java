...
class ThreadAffinityServerConnection extends AbstractReferenceCounted implements Connection, AsyncConnection {
    private final InternalConnection wrapped;
    private final ProtocolExecutor protocolExecutor;
    private final ClusterConnectionMode clusterConnectionMode;

    public ThreadAffinityServerConnection(final InternalConnection wrapped, final ProtocolExecutor protocolExecutor,
    ...
    @Override
    public ThreadAffinityServerConnection retain() {
        return this;
    }
